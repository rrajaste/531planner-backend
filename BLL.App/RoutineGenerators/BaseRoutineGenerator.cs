...
namespace BLL.RoutineGenerators
{
        ...
        where TNewRoutineInfo : BaseNewRoutineInfo
    {
        ...
        protected virtual IEnumerable<TrainingWeek> GenerateTrainingWeeks(Guid parentId, DateTime startingDate)
        {
            ...
            for (var i = 0; i < nrOfTrainingWeeks; i++) weekStartingDates[i] = startingDate.AddDays(i * 7);
        ...
        protected virtual IEnumerable<ExerciseInTrainingDay> GenerateExercises(
            IEnumerable<ExerciseInTrainingDay> baseExercises,
