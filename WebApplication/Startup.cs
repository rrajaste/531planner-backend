...
namespace WebApplication
{
    public class Startup
    {
            ...
            IConfiguration configuration)
        {
            ...
            if (config.GetValue<bool>("DropDatabase")) DataInitializers.DeleteDatabase(context);

            if (config.GetValue<bool>("MigrateDatabase")) DataInitializers.MigrateDatabase(context);

            if (config.GetValue<bool>("SeedData")) DataInitializers.SeedData(context);
