...
namespace WebApplication.ApiControllers
{
    ...
    public class UnitTypesController : ControllerBase
    {
        ...
        [HttpGet]
        [ProducesResponseType(typeof(IEnumerable<UnitType>), 200)]
        ...
        [HttpGet("{id}")]
        [ProducesResponseType(typeof(UnitType), 200)]
        [ProducesResponseType(401)]
        public async Task<ActionResult<UnitType>> GetUnitType(Guid id)
        {
