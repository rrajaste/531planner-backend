...
namespace WebApplication.ApiControllers
{
    ...
    public class MusclesController : ControllerBase
    {
        ...
        [HttpGet]
        [ProducesResponseType(typeof(IEnumerable<Muscle>), 200)]
        ...
        [HttpGet("{id}")]
        [ProducesResponseType(typeof(Muscle), 200)]
        public async Task<ActionResult<IEnumerable<Muscle>>> GetMuscle(Guid id)
        {
