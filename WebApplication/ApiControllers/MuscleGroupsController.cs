...
namespace WebApplication.ApiControllers
{
    ...
    public class MuscleGroupsController : ControllerBase
    {
        ...
        [HttpGet]
        [ProducesResponseType( typeof(IEnumerable<PublicApi.DTO.V1.MuscleGroup>), 200)]
        [HttpGet]
        public async Task<ActionResult<IEnumerable<PublicApi.DTO.V1.MuscleGroup>>> GetMuscleGroups()
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<PublicApi.DTO.V1.MuscleGroup>> GetMuscleGroup(Guid id)
        {
